...
type DateInviteFlowProps = {
  invitationId?: string;
};
export default function DateInviteFlow({invitationId,}: DateInviteFlowProps) {
  ...
  return (
    <main className="min-h-screen bg-linear-to-br from-pink-200 via-rose-100 to-purple-200 flex items-center justify-center md:p-6 overflow-hidden">
      ...
      <Landing launchConfetti={launchConfetti} setAccepted={setAccepted} />
        ...
        <DatePlanner invitationId={invitationId} date={date} time={time} setDate={setDate} setTime={setTime} setSubmitted={setSubmitted} launchConfetti={launchConfetti} />
      ):!altScenario?(    
